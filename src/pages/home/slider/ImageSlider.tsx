           ...
           <div className="max-w-[280px] sm:max-w-[400px] md:max-w-[960px] lg:max-w-[780px] xl:max-w-[960px] pt-[40px] pb-[80px] relative mx-auto lg:pb-0">
               <ul className="cusreviewslider_slider-wrapper__VBzwn">
                  <div className="slick-slider slick-initialized" dir="ltr">
                       <button className=" flex items-center justify-center bottom-[-80px] absolute leading-[0px] left-[50%] w-[56px] h-[56px] rounded-[12px] bg-[#FFFFFF] lg:bottom-[50%] cursor-not-allowed group translate-x-[-62px] lg:translate-x-[-50%] lg:translate-y-[50%] lg:left-[-60px]">
                         <PrevArrow/>
                       </button>
                            ...
                            <div>
                              <div className="flex flex-col md:flex-row overflow-hidden rounded-[18px] relative group ">
                               <div className="max-h-[400px] w-[280px] h-[280px] sm:w-[400px] sm:h-[400px] md:w-[unset] md:h-[unset] lg:w-[320px] lg:h-[320px] relative md:basis-[47%] md:max-w-[320px] leading-[0px] overflow-hidden ">
                                    <img src={Profile1} className="object-cover align-middle" alt="profile" />
                               </div>
                               <div className="max-w-[640px] bg-[#ffffff] flex justify-center flex-col grow md:min-h-[310px]">
                                ...
                                <h4 className="text-[16px] sm:text-[20px] md:text-[24px] leading-[24px] sm:leading-[32px] text-[#020a19] font-bold text-center md:text-left antialiased ">"Most complete MDM solution I found, and I tested many of them, including major names"</h4>
                                </div>
                       ...
                       <button className=" flex items-center justify-center cursor-pointer bottom-[-80px] absolute leading-[0px] left-[50%] w-[56px] h-[56px] rounded-[12px] bg-[#FFFFFF] lg:bottom-[50%] group translate-x-[8px] lg:translate-x-[50%] lg:translate-y-[50%] lg:left-[unset] lg:right-[-60px]">
                        <NextArrow/>
                       </button>
                  </div>
               </ul>
